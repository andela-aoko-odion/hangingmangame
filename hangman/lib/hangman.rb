...
module Hangman
  ...
  def invalid_input
  decrement_count
    puts "Incorrect!".green + " guessed " + " #{@lives} guesses left".green
    puts "You lost, WORD was #{@game_word} " if @lives <= 0
    @status= :wrong
  end
  ...
  def correct_input(char)
    ...
    puts "Correct! keep guessing".green unless game_won
  ...
  def banner
    puts "\t\t#######################################################\n" \
         ...
         "\t\t#                                                     #\n" \
         "\t\t#          Save @ anytime type '*'                    #\n" \
         "\t\t#          Start a new game by typing (n) or (new)    #\n" \
         "\t\t#                                                     #\n" \
         "\t\t#######################################################\n" \
      .green
  end
